...
//}
//
//void CAbstractWindow::ShowFixedSize(const vec2 &size)
//{
...
//        }
//        
//        // Clear buffer, update & draw scene, output buffer.
//        if (running)
//        {
//            m_pImpl->Clear();
...
//}
//
//void CAbstractWindow::SetBackgroundColor(const vec4 &color)
//{
